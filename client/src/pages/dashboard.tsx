                ...
                <CardHeader className="bg-gradient-to-r from-emerald-50 to-blue-50 rounded-t-lg">
                  <div className="flex items-center justify-between">
                    <CardTitle className="flex items-center space-x-2 text-gradient">
                      ...
                      <span>Project "EcoTrack AI" Progress</span>
                    </CardTitle>
                ...
                <CardContent className="p-6">
                  ...
                  <div className="grid md:grid-cols-3 gap-6 mb-6">
                    <div className="text-center p-4 bg-gradient-to-br from-blue-50 to-indigo-50 rounded-xl">
                      <div className="text-2xl font-bold text-gradient mb-1">73%</div>
                      <div className="text-sm text-muted">Development</div>
                      <div className="w-full bg-blue-200 rounded-full h-2 mt-2">
                        <div className="bg-gradient-to-r from-blue-500 to-indigo-600 h-2 rounded-full" style={{ width: '73%' }}></div>
                      </div>
                    </div>
                    
                    <div className="text-center p-4 bg-gradient-to-br from-green-50 to-emerald-50 rounded-xl">
                      <div className="text-2xl font-bold text-gradient-secondary mb-1">8.7</div>
                      <div className="text-sm text-muted">Quality Score</div>
                      <div className="flex justify-center mt-2">
                        {[1,2,3,4,5].map(star => (
                          <i key={star} className={`fas fa-star text-sm ${star <= 4 ? 'text-yellow-400' : 'text-gray-300'}`}></i>
                        ))}
                      </div>
                    </div>
                    
                    <div className="text-center p-4 bg-gradient-to-br from-purple-50 to-pink-50 rounded-xl">
                      <div className="text-2xl font-bold text-gradient mb-1">42h</div>
                      <div className="text-sm text-muted">Time Invested</div>
                      <div className="text-xs text-muted mt-2">Target: 60h</div>
                    </div>
                  </div>
                  ...
                  <div className="space-y-4">
                    <div className="p-4 bg-gradient-to-br from-violet-50 to-purple-50 rounded-xl border border-violet-100">
                      <div className="flex items-start space-x-2">
                        ...
                        <div>
                          <p className="text-sm font-medium text-violet-900">Performance Tip</p>
                          <p className="text-xs text-violet-700 mt-1">Your team's commit frequency has increased 40% this week. Great momentum!</p>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="p-4 bg-gradient-to-br from-emerald-50 to-teal-50 rounded-xl border border-emerald-100">
                      <div className="flex items-start space-x-2">
                        <i className="fas fa-target text-emerald-500 mt-1"></i>
                        <div>
                          <p className="text-sm font-medium text-emerald-900">Goal Prediction</p>
                          <p className="text-xs text-emerald-700 mt-1">Based on current progress, you're on track to finish 2 days early.</p>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="p-4 bg-gradient-to-br from-amber-50 to-orange-50 rounded-xl border border-amber-100">
                      <div className="flex items-start space-x-2">
                        <i className="fas fa-users text-amber-500 mt-1"></i>
                        <div>
                          <p className="text-sm font-medium text-amber-900">Team Sync</p>
                          <p className="text-xs text-amber-700 mt-1">Consider scheduling a team standup. Mike hasn't been active in 6 hours.</p>
                        </div>
                      </div>
                    </div>
                  </div>
